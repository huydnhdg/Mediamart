...
namespace Mediamart.Areas.Admin.Controllers
{
    ...
    public class PriceMoveController : BaseController
    {
        ...
        [Permission(Module = "pricemove.add")]
        [HttpPost]
        ...
        [Permission(Module = "pricemove.edit")]
        [HttpPost]
        ...
        [Permission(Module = "pricemove.delete")]
        ...
        [Permission(Module = "pricemove.upload")]
