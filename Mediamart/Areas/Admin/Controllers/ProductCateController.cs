...
namespace Mediamart.Areas.Admin.Controllers
{
    ...
    public class ProductCateController : BaseController
    {
        ...
        [Permission(Module = "productcate.add")]
        [HttpPost]
        ...
        [Permission(Module = "productcate.edit")]
        [HttpPost]
        ...
        [Permission(Module = "productcate.delete")]
        ...
        [Permission(Module = "productcate.upload")]
