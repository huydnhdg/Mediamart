...
namespace Mediamart.Areas.Admin.Controllers
{
    ...
    public class PriceRepairController : BaseController
    {
        ...
        [Permission(Module = "pricerepair.add")]
        [HttpPost]
        ...
        [Permission(Module = "pricerepair.edit")]
        [HttpPost]
        ...
        [Permission(Module = "pricerepair.delete")]
        ...
        [Permission(Module = "pricerepair.upload")]
